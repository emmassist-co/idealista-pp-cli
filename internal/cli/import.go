...
but do not stop the import.`,
  ...
  idealista-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  idealista-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | idealista-pp-cli import <resource> --input -`,
