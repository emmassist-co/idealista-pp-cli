...
Resource scoping:
  ...
  idealista-pp-cli sync

  # Sync specific resources only
  idealista-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  idealista-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  idealista-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  idealista-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  idealista-pp-cli sync --latest-only`,
...
func defaultSyncResources() []string {
	return []string{
		...
		"pt",
		"pt-ajax-listing-controller-ad-contact-info-for-detail-ajax",
		"pt-home-user-searches",
		"pt-locations-suggest-sale-home",
	}
}
