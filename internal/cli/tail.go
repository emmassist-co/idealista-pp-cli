...
native streaming instead of polling.`,
  ...
  idealista-pp-cli tail --interval 10s

  # Tail a specific resource
  idealista-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  idealista-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
