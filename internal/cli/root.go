...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "idealista-pp-cli",
		Short: "Manage idealista resources via the idealista API",
		Long: `Manage idealista resources via the idealista API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'idealista-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("idealista-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'idealista-pp-cli profile list')")
	...
	rootCmd.AddCommand(newPtCmd(flags))
	rootCmd.AddCommand(newDoctorCmd(flags))
	rootCmd.AddCommand(newCookieCmd(flags))
	...
	rootCmd.AddCommand(newAddetailRecommendationPromotedCmd(flags))
	rootCmd.AddCommand(newDetailPromotedCmd(flags))
	rootCmd.AddCommand(newHomePromotedCmd(flags))
	rootCmd.AddCommand(newLoginAndRegisterApiPromotedCmd(flags))
